...
def inpaint(warped):
    ...
    while left_edge < right_edge:
        warped[2 * old_h - y_top_offset: 3 * old_h + y_bottom_offset, left_edge: left_edge + step] = patch_left_flip
        warped[2 * old_h - y_top_offset: 3 * old_h + y_bottom_offset, right_edge - step: right_edge] = patch_right_flip
        left_edge += step
        right_edge -= step
